...
import { ArrowRight, Wifi, Utensils, Waves, LifeBuoy, MapPin, Coffee, User } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: t.home.amenities.features.core_pilgrimage.title,
      description: t.home.amenities.features.core_pilgrimage.description
    },
    {
        ...
        <section className="section bg-card">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Button asChild className="btn-primary">
                <Link to="/amenities">
                  {t.home.amenities.viewAll} <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button onClick={handleBookingClick} size="lg" className="btn-primary">
                  {t.home.cta.bookNow}
                </Button>
                {!user && (
                  <Button asChild size="lg" variant="outline" className="transition-all duration-300 hover:scale-[1.02]">
